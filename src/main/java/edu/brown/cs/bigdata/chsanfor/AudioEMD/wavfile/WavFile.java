package edu.brown.cs.bigdata.chsanfor.AudioEMD.wavfile;// Wav file IO class
// A.Greensted
...
public class WavFile
{
	...
	// Cannot instantiate chsanford.sequence.wavfile.WavFile directly, must either use newWavFile() or openWavFile()
	private WavFile()
	{
	...
	{
		if (ioState != IOState.READING) throw new IOException("Cannot read from chsanford.sequence.wavfile.WavFile instance");
	...
	{
		if (ioState != IOState.WRITING) throw new IOException("Cannot write to chsanford.sequence.wavfile.WavFile instance");
